...
Before posting, search for an existing issue or discussion. Name the public file, book location, jamovi version, and steps you followed whenever those details apply.

## What does not belong here

- Homework completion or requests for answers to graded work.
- Private, identifiable, clinical, institutional, thesis, restricted, client, or student data. Do not post, attach, or link to such data.
- Individualized model selection or analysis planning for a reader's own research.
- Individualized statistical consulting or interpretation of unpublished results.
- Clinical, legal, or medical advice.

Posts outside this scope may be closed or removed to protect privacy and keep the public companion useful. When a discussion reveals a reproducible defect, a maintainer may ask that it be converted into an issue so the correction can be tracked.
